...
export default function Terms({}: Props) {
  return (
    <div className="prose md:prose-lg mx-auto">
      ...
      <p>
        By accessing this Website, accessible from https://klingai.ai, you are
      ...
      <p>
        ...
        on KlingAI's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on KlingAI's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let KlingAI to terminate upon violations of any of these
      ...
      <p>
        All the materials on KlingAI's Website are provided "as is". KlingAI
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, KlingAI does not make any
      ...
      <p>
        KlingAI or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        KlingAI's Website, even if KlingAI or an authorize representative of
      ...
      <p>
        The materials appearing on KlingAI's Website may include technical,
        typographical, or photographic errors. KlingAI will not promise that any
        of the materials in this Website are accurate, complete, or current.
        KlingAI may change the materials contained on its Website at any time
        without notice. KlingAI does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        KlingAI has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by KlingAI of the site. The use
      ...
      <p>
        KlingAI may revise these Terms of Use for its Website at any time
      ...
      <p>
        Any claim related to KlingAI's Website shall be governed by the laws of
        hk without regards to its conflict of law provisions.
      </p>
    </div>
  );
}
